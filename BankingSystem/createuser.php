...
<body>
 ...
 <?php
  ...
  <div class="container-fluid justify-content-center pt-5">
    <h2 class="text-center pt-1  ml-2 ff">Registration</h2>
    <div class="row justify-content-center mt-4">
      <div class="col-1 shadow" style="border-radius: 8px;">
        <form class="form-container" style="background-color:#499EDA;">
          <div class="row justify-content-center mt-4">
      ...
      <div class="col-12 col-sm-3 ">
        <form class="form-container" style="background-color:#022741" method="post">
          <div class="myform">
  ...
  <footer class="text-center mt-5 py-2">
    <p style="font-family: poppins; font-size: 17px;">&copy 2021. Developed by <b>Adarsh Prabhakar</b> <br> Sparks Foundation</p>
  </footer>
